...
public class TrialGameController_RG : MonoBehaviour, ITrialStateProvider
{
    ...
    [SerializeField] bool showFinger1Cursor = true;
    [SerializeField] bool showFinger2Cursor = true;
    [SerializeField] bool showMcpCursor    = false; // 그랩게임 기본: MCP 커서는 숨김
