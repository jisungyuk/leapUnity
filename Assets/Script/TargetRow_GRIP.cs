...
public class TargetRow_GRIP : MonoBehaviour
{
    ...
    TargetTableController_GRIP controller;

    public void Init(TargetTableController_GRIP owner) { controller = owner; }

    public void SetId(int id)
    {
        if (!idText) { Debug.LogError("TargetRow_GRIP: idText not assigned.", this); return; }
