...
public class SessionRow_GRIP : MonoBehaviour
{
    ...
    private SessionTableController_GRIP controller;

    public void Init(SessionTableController_GRIP owner) { controller = owner; }

    public void SetIndex(int idx)
    {
        if (!trialIndex)
        {
            Debug.LogError("SessionRow_GRIP: 'trialIndex' not assigned.", this);
            return;
        }
